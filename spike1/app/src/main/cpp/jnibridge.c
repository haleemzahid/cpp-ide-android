...
// two native methods:
//
//   nativeRunUserProgram(libPath, outFd, errFd): Int
//     dlopen(libPath) -> dlsym("run_user_main") -> call with pipe fds
//
//   nativeCheckSymbol(libPath, symbol): Boolean
//     diagnostic — is the symbol resolvable in libPath?
//
// Native method naming: JNI auto-resolves via the name
// "Java_<pkg_with_underscores>_<Class>_<method>". Our package is
// dev.cppide.spike1 and class is SpikeRunner.
...
#define LOG_TAG "cppide-spike1-bridge"
...
Java_dev_cppide_spike1_SpikeRunner_nativeRunUserProgram(
...
Java_dev_cppide_spike1_SpikeRunner_nativeCheckSymbol(
        JNIEnv* env, jclass clazz,
...
Java_dev_cppide_spike1_SpikeRunner_nativePtraceTest(
